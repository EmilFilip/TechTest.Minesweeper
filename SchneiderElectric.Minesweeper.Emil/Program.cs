...
while (gameOn)
{
    ...
    //I run out of time. The is a repo uploaded to my github accout that contains code for the mars rover tech test
    //which contains code quite similar to what I was supposed to created next i.e. verify if it's possible to move to the next cell
}
